...
//				striker_3.y_ball[1] = striker_3.y_or[2];
		...
		if (PROGRAM_UNTUK == STRIKER_2)
		{
			printf("\n   STRIKER 2 --> Jarak,Sudut Bola = %d,%d -- Koordinat = %d,%d -- Positioning = %d,%d -- Dummy = %d,%d -- YAW = %d", (int)striker_2.distance_ball[1], (int)striker_2.angle_ball[0], (int)striker_2.x_or[1], (int)striker_2.y_or[1], (int)striker_2.coor_y[1], (int)striker_2.coor_x[1], dummy_pos1, dummy_pos2,/* striker_2.x_ball[0], striker_2.y_ball[0],*/ striker_2.yaw[1]);
			printf("\n   STRIKER 3 --> Jarak.Sudut Bola = %d,%d -- Koordinat = %d,%d -- Positioning = %d,%d -- Dummy = %d,%d -- YAW = %d\n", (int)striker_3.distance_ball[0], (int)striker_3.angle_ball[0], (int)striker_3.coor_x[1], (int)striker_3.coor_y[1], (int)striker_3.coor_y[1], (int)striker_3.coor_x[1], dummy_pos1, dummy_pos2, striker_3.yaw[0]);
