...
// printf("%s\n", buff_rcv);
Parsing_data2(buff_rcv, X, Y, Z, striker_3.coor_x[0], striker_3.coor_y[0], striker_2.coor_x[0], striker_2.coor_y[0], 
flag_wifi, striker_3.coor_x[2], striker_3.coor_y[2], striker_2.coor_x[2], striker_2.coor_y[2], dummy_pos1, dummy_pos2, dummy_pos3, dummy_pos4,
striker_2.yaw[0], striker_3.yaw[0], striker_2.distance_ball[0], striker_3.distance_ball[0], striker_3.reset_x[0], 
striker_3.reset_y[0], striker_2.reset_x[0], striker_2.reset_y[0], TEAM, mode_marking, striker_2.angle_ball[1], 
striker_3.angle_ball[1], striker_3.x_cm[0], striker_3.y_cm[0], 
striker_2.x_cm[0], striker_2.y_cm[0], timer2, timer3, flagStriker);

// printf("%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",X, Y, Z, striker_3.coor_x[0], striker_3.coor_y[0], striker_2.coor_x[0], striker_2.coor_y[0], 
// flag_wifi, striker_3.coor_x[2], striker_3.coor_y[2], striker_2.coor_x[2], striker_2.coor_y[2], dummy_pos1, dummy_pos2, dummy_pos3, dummy_pos4);
// // striker_2.yaw[0], striker_3.yaw[0], striker_2.distance_ball[0], striker_3.distance_ball[0], striker_3.reset_x[0], 
// // striker_3.reset_y[0], striker_2.reset_x[0], striker_2.reset_y[0], TEAM, mode_marking, striker_2.angle_ball[1], 
// // striker_3.angle_ball[1], striker_3.x_cm[0], striker_3.y_cm[0], 
				...
				if (TEAM == CYAN)
				{
					...
					if(count_ > 15){
						if(count_send % counter_S2_2 == 0){
							...
							fprintf(serial_send, "90,%d,%d,%d,%d,%d,%d\n", dummy_pos1, dummy_pos2, dummy_pos3, dummy_pos4, timer3, flagStriker);}
...
//					fprintf(serial_send, "17,%d,%d\n", (int)striker_2.angle_obs, (int)striker_2.jarak_obs);
				...
				/*else if (TEAM == MAGENTA)
				{
					...
					if(count_send % counter_S2_1 == 0)fprintf(serial_send, "%d,%d,%d,%d,0\n", Header, Data1, Data2, mode_formasi[1]);					//Send Odometry Field To Robot
					if(count_ > 15){
						if(count_send % counter_S2_2 == 0)fprintf(serial_send, "13,%d,%d,%d,%d,%d\n", (int)striker_2.x_mk_pos, (int)striker_2.y_mk_pos, (int)striker_3.x_or[1], (int)striker_3.y_or[1],flag_wifi);
				...
				if (TEAM == CYAN)
				{
					...
					if(count_ > 15){
						if(count_send % counter_S3_2 == 0){
							...
							fprintf(serial_send, "90,%d,%d,%d,%d,%d,%d\n", dummy_pos1, dummy_pos2, dummy_pos3, dummy_pos4, timer2, flagStriker);}
...
//				striker_3.y_ball[1] = striker_3.y_or[2];
			...
			if (PROGRAM_UNTUK == STRIKER_2)
			{
				striker_2.x_or[1] = 100; striker_2.y_or[1] = 200;
		...
		// if (TEAM == CYAN) printf("\n%d. UDP_CLIENT %s -- RefBox = %d,%d,%d -- %s -- Team = %s -- mode = %d,%d -- ", count, SERVER, Header, Data1, Data2, rcvString, "CYAN", mode_marking, mode_formasi[1]);
		// else if (TEAM == MAGENTA) printf("\n%d. UDP_CLIENT %s -- RefBox = %d,%d,%d -- %s -- Team = %s -- mode = %d,%d -- ", count, SERVER, Header, Data1, Data2, rcvString, "MAGENTA", mode_marking, mode_formasi[1]);
		printf("\n%d. UDP_CLIENT %s -- RefBox = %d,%d,%d -- Team = %s -- mode robot, striker = %d,%d -- ", count, SERVER, Header, Data1, Data2, rcvString, flag_wifi, flagStriker);
		...
		if (PROGRAM_UNTUK == STRIKER_2)
		{
			printf("\n   STRIKER 2 --> Jarak,Sudut Bola = %d,%d -- Koordinat = %d,%d -- Positioning = %d,%d -- Dummy = %d,%d,%d,%d -- YAW = %d -- TIMER = %d", (int)striker_2.distance_ball[1], (int)striker_2.angle_ball[0], (int)striker_2.x_or[1], (int)striker_2.y_or[1], (int)striker_2.coor_y[1], (int)striker_2.coor_x[1], dummy_pos1, dummy_pos2, dummy_pos3, dummy_pos4,/* striker_2.x_ball[0], striker_2.y_ball[0],*/ striker_2.yaw[1], timer2);
			printf("\n   STRIKER 3 --> Jarak.Sudut Bola = %d,%d -- Koordinat = %d,%d -- Positioning = %d,%d -- Dummy = %d,%d,%d,%d -- YAW = %d -- TIMER = %d\n", (int)striker_3.distance_ball[0], (int)striker_3.angle_ball[0], (int)striker_3.coor_x[1], (int)striker_3.coor_y[1], (int)striker_3.coor_y[1], (int)striker_3.coor_x[1], dummy_pos1, dummy_pos2, dummy_pos3, dummy_pos4, striker_3.yaw[0], timer3);
//				printf("\n   A[%d],B[%d],C[%d],D[%d] = %.2f | %.2f | %.2f | %.2f\n", 0, 0, 0, 0, pengali_A[0], pengali_B[0], penambah_C[0],penambah_D[0]);
				printf("   FORMASI = %d\n", mode_formasi[1]);
		}
		if (PROGRAM_UNTUK == STRIKER_3)
		{
			printf("\n   STRIKER 2 --> Jarak,Sudut Bola = %d,%d -- Koordinat = %d,%d -- Positioning = %d,%d -- Dummy = %d,%d,%d,%d -- YAW = %d -- TIMER = %d", (int)striker_2.distance_ball[0], (int)striker_2.angle_ball[1], (int)striker_2.coor_x[1], (int)striker_2.coor_y[1], (int)striker_2.coor_y[1], (int)striker_2.coor_x[1], dummy_pos1, dummy_pos2, dummy_pos3, dummy_pos4, striker_2.yaw[0], timer2);
			printf("\n   STRIKER 3 --> Jarak,Sudut Bola = %d,%d -- Koordinat = %d,%d -- Positioning = %d,%d -- Dummy = %d,%d,%d,%d -- YAW = %d -- TIMER = %d\n", (int)striker_3.distance_ball[1], (int)striker_3.angle_ball[0], (int)striker_3.x_or[1], (int)striker_3.y_or[1], (int)striker_3.coor_y[1], (int)striker_3.coor_x[1], dummy_pos1, dummy_pos2, dummy_pos3, dummy_pos4,/* (int)striker_3.x_ball[0], (int)striker_3.y_ball[0],*/ (int)striker_3.yaw[1], timer3);
