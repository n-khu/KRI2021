...
//        {
            ...
            moveData(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t);
...
//                    markingModeUDP);
            ...
            sprintf(buffer_send,"%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
                ref1,ref2,ref3,
                striker_3_temporary.coor_x[2],striker_3_temporary.coor_y[2],
                striker_2_temporary.coor_x[2],striker_2_temporary.coor_y[2],
                button,//keeper_temporary.coor_x[2],keeper_temporary.coor_y[2],
                striker_3_temporary.coor_x[4],striker_3_temporary.coor_y[4],
                striker_2_temporary.coor_x[4],striker_2_temporary.coor_y[4],
                dummy1, dummy2, dummy3, dummy4,  //keeper_temporary.coor_x[4],keeper_temporary.coor_y[4],
                striker_2_temporary.yaw,striker_3_temporary.yaw,//keeper_temporary.yaw,
                striker_2_temporary.dist_ball,striker_3_temporary.dist_ball,//keeper_temporary.dist_ball,
                striker_3_temporary.coor_x[5],striker_3_temporary.coor_y[5],
                striker_2_temporary.coor_x[5],striker_2_temporary.coor_y[5],
                TEAMUDP,markingModeUDP,
                striker_3_temporary.angle_ball,striker_2_temporary.angle_ball,//keeper_temporary.angle_ball,
                striker_3_temporary.x_ball[0],striker_3_temporary.y_ball[0],
                striker_2_temporary.x_ball[0],striker_2_temporary.y_ball[0],
                //keeper_temporary.x_ball[0],keeper_temporary.y_ball[0],
                timer2, timer3, flagStriker
                // FIELDUDP,formationModeUDP
                );
...
//            for (int i = 0; i < 3; ++i)
//            {
//                MsgSend.append((const char*)(Msg + i), sizeof(int));
//            }

//            udpsocket->writeDatagram(MsgSend,QHostAddress(SERVER),clientPort);
//            qDebug() << MsgSend;
...
void UDP::moveData(int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int)
{
    if (a == 111)		//STRIKER_2
    {
        striker_2_temporary.coor_x[0] = b;
        striker_2_temporary.coor_y[0] = c;
        striker_2_temporary.dist_ball = d;
        striker_2_temporary.angle_ball = e;
        striker_2_temporary.x_ball[0] = f;
        striker_2_temporary.y_ball[0] = g;
        ...
        striker_2_temporary.x_cm[0] = i;
        striker_2_temporary.y_cm[0] = j;
        striker_2_temporary.volt = k;
        striker_2_temporary.timer = l;
        striker_2_temporary.mark = 1;
//            qDebug() << striker_2_temporary.coor_x[0];
        emit rcvUDPData(a, striker_2_temporary.coor_x[0], striker_2_temporary.coor_y[0], striker_2_temporary.dist_ball, striker_2_temporary.angle_ball, striker_2_temporary.x_ball[0], striker_2_temporary.y_ball[0], striker_2_temporary.yaw);
    }
    ...
    if (a == 222)		//STRIKER_3
    {
        striker_3_temporary.coor_x[0] = b;
        striker_3_temporary.coor_y[0] = c;
        striker_3_temporary.dist_ball = d;
        striker_3_temporary.angle_ball = e;
        striker_3_temporary.x_ball[0] = f;
        striker_3_temporary.y_ball[0] = g;
        ...
        striker_3_temporary.x_cm[0] = i;
        striker_3_temporary.y_cm[0] = j;
        striker_3_temporary.volt = k;
        striker_3_temporary.timer = l;
        striker_3_temporary.mark = 1;
        emit rcvUDPData(a, striker_3_temporary.coor_x[0], striker_3_temporary.coor_y[0], striker_3_temporary.dist_ball, striker_3_temporary.angle_ball, striker_3_temporary.x_ball[0], striker_3_temporary.y_ball[0], striker_3_temporary.yaw);
    }
    ...
    if (a == 333)		//KEEPER
    {
        keeper_temporary.coor_x[0] = b;
        keeper_temporary.coor_y[0] = c;
        keeper_temporary.dist_ball = d;
        keeper_temporary.angle_ball = e;
        keeper_temporary.x_ball[0] = f;
        keeper_temporary.y_ball[0] = g;
