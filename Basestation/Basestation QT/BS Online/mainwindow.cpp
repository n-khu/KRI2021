    ...
    ui(new Ui::MainWindow)
{
    ...
    this->setWindowTitle("ENSPARTAN BASESTATION");
...
void MainWindow::mouseClicked()
{
    ...
    {
        flagResetGK = 1;
        keeper.coor_x[1] = ui->label_lapangan->x + 390;
        keeper.coor_y[1] = ui->label_lapangan->y + 10;
//        ui->label_58->setText(QString("%1, %2").arg(keeper.coor_x[1]).arg(keeper.coor_y[1]));
    }
    if(robotChosen == 4)    //STRIKER 1
    {
        flagResetST3 = 1;
        striker_1.coor_x[1] = ui->label_lapangan->x + 390;
        striker_1.coor_y[1] = ui->label_lapangan->y + 10;
//        ui->label_40->setText(QString("%1, %2").arg(striker_1.coor_x[1]).arg(striker_1.coor_y[1]));
    }
    if(robotChosen == 2)    //STRIKER 2
    {
        flagResetST2 = 1;
        striker_2.coor_x[1] = ui->label_lapangan->x + 390;
        striker_2.coor_y[1] = ui->label_lapangan->y + 10;
//        ui->label_25->setText(QString("%1, %2").arg(striker_2.coor_x[1]).arg(striker_2.coor_y[1]));
    ...
    {
        flagResetST3 = 1;
        striker_3.coor_x[1] = ui->label_lapangan->x + 390;
        striker_3.coor_y[1] = ui->label_lapangan->y + 10;
...
{
    ui->label_44->setText(QString("%1, %2").arg(ui->label_lapangan->x).arg(ui->label_lapangan->y*-1+450));
}
